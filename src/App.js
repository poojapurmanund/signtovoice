...
function App() {
  ...
  const runCoco = async () => {
    ...
    // https://tensorflowjssign.s3.us-east.cloud-object-storage.appdomain.cloud/model.json

    const net = await tf.loadGraphModel('https://tensorflowjssign.s3.us-east.cloud-object-storage.appdomain.cloud/model.json')
